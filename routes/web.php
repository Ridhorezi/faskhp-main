...
Route::group(['middleware' => ['auth']], function () {
    Route::post('logout', [DashboardController::class, 'logout'])->name(
        'logout'
    );

    Route::group(
        ['middleware' => ['role_or_permission:SuperAdmin|edit profile']],
        function () {
    ...
    Route::group(['middleware' => ['role:disabled']], function () {
        Route::view('/disabled/dashboard', 'disabled')->name(
            'disabled.dashboard'
        );
    });
});
