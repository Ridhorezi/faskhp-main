...
function sidebarColor(e) {
  ...
  ;(e = document.querySelector('#sidenavCardIcon')),
    (n = ['ni', 'ni-diamond', 'text-gradient', 'text-lg', 'top-0', 'text-' + n])
...
//       ? function () {
//           5 < window.scrollY
//             ? (t.classList.add(...n), t.classList.remove(...i),
//             s('blur'))
//             : a()
//         }
//       : function () {
        ...
        s.querySelector(
          ...
          if (s.classList.contains('flex-column')) {
            ...
            ;(l.style.transform = 'translate3d(' + e + 'px, 0px, 0px)'),
              (l.style.width =
                s.querySelector('li:nth-child(' + i + ')').offsetWidth + 'px')
          }
        }
      }
    })
