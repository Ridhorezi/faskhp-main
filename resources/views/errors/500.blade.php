...
<body>
    ...
    <body class="permission_denied">
        ...
        <div class="denied__wrapper">
            <h1>500</h1>
            <h3>Ups! Something when wrong, Internal Server Error.</h3>
            <svg id="astronaut" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <path d="M346.4 475H164.9V244.8c0-14 11.4-25.4 25.4-25.4H321c14 0 25.4 11.4 25.4 25.4V475z"
                    class="st2" />
                <path
                ...
                <path d="M344.4 241v235.9h-36V232.1c0-4.8-2.2-9.2-5.9-12.8h11.7c16.6.1 30.2 9.8 30.2 21.7z"
                    class="st4 st5" />
                <path
