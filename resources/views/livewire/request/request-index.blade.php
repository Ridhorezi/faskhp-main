@section('title', 'Table Add Data Request')
<div>
    <div class="card shadow">
        <div class="card-header">
            <h5 class="mb-3 text-body">Table Add Data Request</h5>
            <div>
                                ...
                                @else
                                    <td class="text-center">
                                        <button class="btn btn-success btn-sm" disabled
                                            wire-key="approve-{{ $request->user_id }}"><i
                                                class="fa-solid fa-check"></i></button>
                                    </td>
                                    <td class="text-center">
                                        <button class="btn btn-secondary btn-sm" disabled
                                            wire-key="decline-{{ $request->user_id }}"><i
                                                class="fa-solid fa-times"></i></button>
                                    </td>
                                @endif
                                <td class="text-center"><button class="btn btn-info btn-sm"
                                        wire:click="openDetails({{ $request->relasi_id }})"
                                        wire:key='open-details-modal{{ $request->relasi_id }}'><i
                                            class="fa-solid fa-eye"></i></button></td>
                                {{-- <td class="text-center"><button class="btn btn-sm btn-danger"
                                        wire:click='openDelete({{ $request->user_id }})'
                                        wire:key='open-delete-modal-{{ $request->user_id }}'><i
