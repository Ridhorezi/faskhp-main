...
<div>
    <div class="card shadow">
        <div class="card-header">
            <h5 class="mb-3 text-body">Table Edit Data Request</h5>
            <div>
                ...
                <div class="alert bg-gradient-primary text-light m-2 mt-4">Tindakan tidak dapat di kembalikan ke semula.
                </div>
            </div>
        </div>
        <div class="card-body">
