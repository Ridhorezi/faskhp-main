<div>
    ...
    <section wire:ignore id="hero">
        <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
            <h1 class="mb-4 pb-0 pop">Alumni Berstatus Kuliah</h1>
            ...
            <div class="container" wire:ignore.self data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-sm-6 offset-sm-3 mt-4 mb-3">
                        <h2 class="text-center">Daftar Alumni Kuliah</h2>
                    ...
                    @foreach ($collages as $collage)
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-box text-center">
                                @if ($collage->gambar)
                                    <div class="user-pic">
                                        <img src="{{ asset('storage/kuliah/' . $collage->gambar) }}" class="img-fluid">
                                    </div>
                                @else
                                    <div class="user-pic">
                                ...
                                <hr>
                                <ul class="text-start">
                                    <li>Jenis Kelamin : {{ $collage->jenis_kelamin == 'l' ? 'Laki-Laki' : 'Perempuan' }}
                                    </li>
                                    <li>Nama Universitas : {{ $collage->nama_universitas }}</li>
                                    <li>Jurusan : {{ $collage->jurusan }}</li>
                                    <li>Di daftarkan : {{ $collage->created_at }}</li>
                                    <li>Di buat :
                                        @if ($collage->dibuat == 1)
                                            {{ 'Administrator' }}
                                        @else
                                ...
                                <hr>
                                @if ($collage->user_id != Auth::user()->id)
