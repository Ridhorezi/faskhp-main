<div>
    ...
    <section wire:ignore id="hero">
        <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
            <h1 class="mb-4 pb-0 pop">Fomulir Edit Data Kuliah</h1>
    ...
    <main id="main" style="margin-top:10em; margin-bottom:7em;">
        ...
        <section class="m-3 mb-3 vh-100 d-flex align-items-center justify-content-center" id="fomulir">
            <div class="container" wire:ignore.self data-aos="fade-up">
                <div class="section-header">
                    <h4 class="text-center">Fomulir Alumni yang sedang Kuliah</h4>
                </div>
                <div class="card shadow" style="margin-left: 7%;">
                    <div class="card-header">
                        Edit Data Kuliah Kuliah
                    </div>
                    <div class="card-body">
                        <form wire:submit.prevent='update' enctype="multipart/form-data">
                            <div class="row row-cols-2">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    @if ($gambarUpdated)
                                        <p>Preview:</p>
                                        <img src="{{ $gambar->temporaryUrl() }}" style="max-width:110px;max-height:110px;border-radius:5px;" alt="preview">
                                    @else
                                        <p>Current:</p>
                                        @if ($gambar)
                                            <img src="{{ asset('storage/kuliah/' . $gambar) }}" style="max-width:110px;max-height:110px;border-radius:5px;" alt="preview"
                                                width="100">
                                        @else
                            ...
                            <button class="btn btn-sm btn-secondary" type="button"
                                onclick="location.href='{{ route('user.kuliah') }}'">Back</button>
                        </form>
                    </div>
                </div>
        </section>
