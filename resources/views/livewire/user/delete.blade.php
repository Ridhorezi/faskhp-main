<div>
    <section wire:ignore id="hero">
        <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
            <h1 class="mb-4 pb-0 pop">Hapus Data</h1>
            {{-- <a href="#card" class="about-btn scrollto"><i class="bi bi-arrow-down"></i></a> --}}
            <a class="mouse-icon scrollto" href="#card">
    ...
    @endpush
    <main id="main" style="margin-top:2em; margin-bottom:2em;">

        <section class="m-3 mb-3 vh-100 d-flex align-items-center justify-content-center" id="card">
            <div class="container" wire:ignore.self data-aos="fade-up">
                <div class="section-header">
                    <h4 class="text-center">Menghapus Data</h4>
                </div>
                <div class="card shadow" style="margin-left: 6%;">
                    ...
                    <div class="card-body">
                        Untuk menghapus data anda dipersilahkan untuk menghubungi admin melalui link di bawah ini.
                        <ul>
                            <li><i class="fa-brands fa-instagram"></i> <a
                                    href="https://www.instagram.com/">Instagram</a></li>
                            <li><i class="fa-brands fa-whatsapp"></i> <a href="https://wa.me/">Whatsapp</a></li>
                            ...
                            <li><i class="fa-solid fa-envelope"></i> <a href="">Email</a>
                            </li>
                        </ul>
                    </div>
                </div>
