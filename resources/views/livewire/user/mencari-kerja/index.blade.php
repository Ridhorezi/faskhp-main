<div>
    ...
    <section wire:ignore id="hero">
        <div class="hero-container" findjob-aos="zoom-in" findjob-aos-delay="100">
            <h1 class="mb-4 pb-0 pop">Alumni Berstatus Mencari Kerja</h1>
    ...
    <main id="main">
        ...
        <section class="m-3 mb-3" id="daftar">
            <div class="container" wire:ignore.self findjob-aos="fade-up">
                <div class="row">
                    <div class="col-sm-6 offset-sm-3 mt-4 mb-3">
                        <h2 class="text-center">Daftar Alumni Mencari Kerja</h2>
                    ...
                    @foreach ($findJobs as $findjob)
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-box text-center">
                                ...
                                <hr>
                                <ul class="text-start">
                                    <li>Jenis Kelamin : {{ $findjob->jenis_kelamin == 'l' ? 'Laki-Laki' : 'Perempuan' }}
                                    </li>
                                    <li>Alamat : <a target="_blank" findjob-bs-toggle="tooltip"
                                            style="color:blueviolet;" findjob-placement="top" title="Find on GMaps"
                                            href="https://maps.google.com/maps/search/{{ $findjob->alamat }}">
                                            {{ $findjob->alamat }}</a>
                                    </li>
                                    <li>Alasan Mencari Kerja : {{ $findjob->alasan_mencari_kerja }}</li>
                                    <li>Kontak : <input type="text" class="form-control form-control-sm"
                                    ...
                                    <li>Di Daftarkan : {{ $findjob->created_at }}</li>
                                    <li>Di Buat :
                                    @if ($findjob->dibuat == 1)
                                        {{ 'Administrator' }}
                                    @else
                                ...
                                <hr>
                                @if ($findjob->user_id != Auth::user()->id)
