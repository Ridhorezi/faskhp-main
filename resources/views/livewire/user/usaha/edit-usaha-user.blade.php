<div>
    ...
    <section wire:ignore id="hero">
        <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
            <h1 class="mb-4 pb-0 pop">Fomulir Edit Data Membuka - Usaha</h1>
    ...
    <main id="main" style="margin-top:12em; margin-bottom:12em;">
                        ...
                        <form wire:submit.prevent='update' enctype="multipart/form-data">
                            <div class="row row-cols-2">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    @if ($gambarUpdated)
                                        <p>Preview:</p>
                                        <img src="{{ $gambar->temporaryUrl() }}" width="100" alt="preview">
                                    @else
                                        <p>Current:</p>
                                        @if ($gambar)
