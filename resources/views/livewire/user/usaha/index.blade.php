<div>
    ...
    <section wire:ignore id="hero">
        <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
            <h1 class="mb-4 pb-0 pop">Alumni Berstatus Membuka Usaha</h1>
            ...
            <div class="container" wire:ignore.self data-aos="fade-up">
                <div class="row">
                    <div class="col-sm-6 offset-sm-3 mt-4 mb-3">
                        <h2 class="text-center">Daftar Alumni Membuka Usaha</h2>
                    ...
                    @foreach ($businesses as $business)
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-box text-center">
                                @if ($business->gambar)
                                    <div class="user-pic">
                                        <img src="{{ asset('storage/usaha/' . $business->gambar) }}" class="img-fluid">
                                    </div>
                                @else
                                    <div class="user-pic">
                                ...
                                <ul class="text-start">
                                    ...
                                    <li>Alamat Usaha : <a target="_blank" findjob-bs-toggle="tooltip"
                                            style="color:blueviolet;" findjob-placement="top" title="Find on GMaps"
                                            href="https://maps.google.com/maps/search/{{ $business->alamat_usaha }}">
                                            {{ $business->alamat_usaha }}</a>
                                    </li>
                                    <li>Jenis Usaha: {{ $business->jenis_usaha }}</li>
                                    <li>Tahun Usaha: {{ $business->tahun_usaha }}</li>
                                    <li>Di daftarkan: {{ $business->created_at }}</li>
                                    <li>Di buat:
                                        @if ($business->dibuat == 1)
                                            {{ 'Administrator' }}
                                        @else
                                            {{ $business->dibuat }}
                                        @endif
                                    ...
                                    <div class="btn-group dropup" style="margin-left:55%;">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('user.edit.usaha', $business->slug) }}">Request
                                                    Edit</a></li>
