@section('title', 'Reset Password | FASKHP')
<div>
                                ...
                                <div class="card-body">
                                    ...
                                    @if ($showFailureNotification)
                                        <div wire:model="showFailureNotification"
                                            ...
                                            <span
                                                class="alert-text">{{ 'Please enter the correct email address!' }}</span>
                                    ...
                                    <form wire:submit.prevent="resetPassword" action="#" method="POST"
                                        ...
                                        <div>
                                            ...
                                            <div
                                                class="@error('password')border border-danger rounded-3 @enderror mb-3">
